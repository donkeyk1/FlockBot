...
client.on('messageCreate', message =>{
    ...
    if(command === 'ping'){
        ...
        var days = calculateDifference(new Date("05/03/2002"));
        message.channel.send(`Days <@272494999680188417> don has blessed us with his presence: ` + (days|0));
        const donEmbed = new MessageEmbed()
        .setTitle('Chad')
        .setImage("https://i.imgur.com/hmn7X3M.jpeg")
